...
document.addEventListener('DOMContentLoaded', _np_updateMenuCompact);
    ...
    const menuItems = [
        ...
        { id: 'portuguesa', name: 'Portuguesa', description: 'Molho,\ mussarela,\ presunto,\ ovo,\ cebola,\ pimentão,\ orégano,\ azeitona\.', category: 'tradicionais', image: 'images/pizza-portuguesa.jpeg', priceOptions: { media: { size: 'Média', price: 33.00 }, grande: { size: 'Grande', price: 36.00 } }, defaultSize: 'grande', allowTwoFlavors: true },
        { id: 'quatro-queijos', name: 'Quatro Queijos', description: 'Molho,\ mussarela,\ catupiry,\ cheddar,\ queijo\ coalho,\ orégano,\ azeitona\.', category: 'tradicionais', image: 'images/pizza-quatro-queijos.jpeg', priceOptions: { media: { size: 'Média', price: 33.00 }, grande: { size: 'Grande', price: 36.00 } }, defaultSize: 'grande', allowTwoFlavors: true },
